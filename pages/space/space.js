...
Page({
  ...
  onLoad: function () {
    ...
    wx.request({
      //url: BASE_URL + 'url',
      url: 'http://192.168.10.123:8888/zhuhu/users',
      method: 'POST',
      header: {
      ...
      success: function(res) {
        ...
        _this.setData({
          spacedata: {
            ...
            feeScaleRoom: res.data.data[0].feeScaleRoom,
            feeScaleRoomUnitValue: res.data.data[0].feeScaleRoomUnitValue,
            policy: res.data.data[0].policy,
            roomRate: res.data.data[0].roomRate,
            summary: res.data.data[0].summary,
            totalBulidingArea: res.data.data[0].totalBulidingArea,
            totalRoom: res.data.data[0].totalRoom,
            totalWorkstation: res.data.data[0].totalWorkstation
          },
          spaceimgs:["../../images/test.jpg","../../images/test.jpg","../../images/test.jpg"]
        })
        console.log(_this.data.spacedata)
      },
      fail: function(res) {
        console.log(res)
      }
